...
class EgnyteInterface:
    ...
    def __init__(self, egnyte_domain, egnyte_access_token, project_id=None, cdd_interface=None):
    ...
    def _upload_assay_runs(self):
        ...
        for mapping_template_id, assay_run_file_list in self.assay_runs_to_upload.items():
            ...
            for assay_run_group_key, assay_run_list in self.cdd_interface.validate_and_group_file_arrays(assay_run_file_list, mapping_template_id).items():
